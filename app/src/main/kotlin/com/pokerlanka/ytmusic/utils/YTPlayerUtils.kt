...
package com.pokerlanka.ytmusic.utils
...
import com.pokerlanka.innertube.strategy.ContentAwareFallbackStrategy
import com.pokerlanka.innertube.strategy.ContentHints
import com.pokerlanka.ytmusic.constants.AudioQuality
import com.pokerlanka.ytmusic.utils.YTPlayerUtils.MAIN_CLIENT
import com.pokerlanka.ytmusic.utils.YTPlayerUtils.validateStatus
import com.pokerlanka.ytmusic.utils.cipher.CipherDeobfuscator
import com.pokerlanka.ytmusic.utils.cipher.FunctionNameExtractor
import com.pokerlanka.ytmusic.utils.cipher.PlayerJsFetcher
import com.pokerlanka.ytmusic.utils.potoken.PoTokenGenerator
import com.pokerlanka.ytmusic.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        val mainPlayerResponse = YouTube
            .player(videoId, playlistId, MAIN_CLIENT, signatureTimestamp, poToken?.playerRequestPoToken)
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; YTmusic cannot recover those without official playback.
    ...
    suspend fun playerResponseForMetadata(
        ...
        return YouTube.player(videoId, playlistId, WEB_REMIX, signatureTimestamp, poToken?.playerRequestPoToken)
