            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.pokerlanka.ytmusic.db.entities.Song(
                            song =
                                com.pokerlanka.ytmusic.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.pokerlanka.ytmusic.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.pokerlanka.ytmusic.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
