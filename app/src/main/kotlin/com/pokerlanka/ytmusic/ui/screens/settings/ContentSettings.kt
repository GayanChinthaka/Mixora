...
import com.pokerlanka.ytmusic.constants.ContentCountryKey
import com.pokerlanka.ytmusic.constants.ContentLanguageKey
import com.pokerlanka.ytmusic.constants.CountryCodeToName
import com.pokerlanka.ytmusic.constants.EnableBetterLyricsKey
import com.pokerlanka.ytmusic.constants.EnableKugouKey
import com.pokerlanka.ytmusic.constants.EnableLrcLibKey
import com.pokerlanka.ytmusic.constants.EnablePaxsenixKey
import com.pokerlanka.ytmusic.constants.EnableLyricsPlus
...
import com.pokerlanka.ytmusic.constants.LanguageCodeToName
import com.pokerlanka.ytmusic.constants.LyricsProviderOrderKey
import com.pokerlanka.ytmusic.constants.ProxyEnabledKey
import com.pokerlanka.ytmusic.constants.ProxyPasswordKey
import com.pokerlanka.ytmusic.constants.ProxyTypeKey
import com.pokerlanka.ytmusic.constants.ProxyUrlKey
import com.pokerlanka.ytmusic.constants.ProxyUsernameKey
import com.pokerlanka.ytmusic.constants.QuickPicks
import com.pokerlanka.ytmusic.constants.QuickPicksKey
import com.pokerlanka.ytmusic.constants.RandomizeHomeOrderKey
import com.pokerlanka.ytmusic.constants.SYSTEM_DEFAULT
import com.pokerlanka.ytmusic.constants.ShowArtistDescriptionKey
import com.pokerlanka.ytmusic.constants.ShowMostStatsPlaylistsKey
import com.pokerlanka.ytmusic.constants.ShowArtistSubscriberCountKey
import com.pokerlanka.ytmusic.constants.ShowMonthlyListenersKey
import com.pokerlanka.ytmusic.constants.ShowWrappedCardKey
import com.pokerlanka.ytmusic.constants.TopSize
...
import com.pokerlanka.ytmusic.ui.component.DraggableLyricsProviderItem
import com.pokerlanka.ytmusic.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.pokerlanka.ytmusic.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.pokerlanka.ytmusic.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.pokerlanka.ytmusic.db.entities.PlaylistEntity(
                        id = com.pokerlanka.ytmusic.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.pokerlanka.ytmusic.db.entities.PlaylistEntity(
                        id = com.pokerlanka.ytmusic.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
