...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.pokerlanka.mixora.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.pokerlanka.mixora.widget.playlists.UPDATE_WIDGET"
