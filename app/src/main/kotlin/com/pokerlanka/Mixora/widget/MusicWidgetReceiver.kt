...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.pokerlanka.mixora.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.pokerlanka.mixora.widget.LIKE"
        const val ACTION_NEXT = "com.pokerlanka.mixora.widget.NEXT"
        const val ACTION_PREVIOUS = "com.pokerlanka.mixora.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.pokerlanka.mixora.widget.UPDATE_WIDGET"
    }
}
