            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.pokerlanka.mixora.db.entities.Song(
                            song =
                                com.pokerlanka.mixora.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.pokerlanka.mixora.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.pokerlanka.mixora.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
