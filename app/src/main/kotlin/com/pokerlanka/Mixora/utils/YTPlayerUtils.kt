...
import com.pokerlanka.mixora.utils.YTPlayerUtils.MAIN_CLIENT
import com.pokerlanka.mixora.utils.YTPlayerUtils.validateStatus
import com.pokerlanka.mixora.utils.cipher.CipherDeobfuscator
import com.pokerlanka.mixora.utils.cipher.FunctionNameExtractor
import com.pokerlanka.mixora.utils.cipher.PlayerJsFetcher
import com.pokerlanka.mixora.utils.potoken.PoTokenGenerator
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; Mixora cannot recover those without official playback.
